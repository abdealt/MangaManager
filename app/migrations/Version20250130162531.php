 ...
 */
final class Version20250130162531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manga ADD category_id INT NOT NULL, DROP description');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manga ADD description VARCHAR(255) DEFAULT NULL, DROP category_id');
    }
}
